...
\resizebox{1\textwidth}{!}{\includegraphics{img/geo_base.eps}}
...
\resizebox{0.3\textwidth}{!}{\includegraphics{img/graphes_mauvais.eps}}
...
\resizebox{0.3\textwidth}{!}{\includegraphics{img/graphe_bon.eps}}
...
\resizebox{0.75\textwidth}{!}{\includegraphics{img/espace_stat_tension.eps}}
...
\begin{figure}[h]
\centering
\resizebox{0.75\textwidth}{!}{\includegraphics{img/geo_base_comp_pm.eps}}
...
\begin{figure}[h] 
\centering
\resizebox{0.75\textwidth}{!}{\includegraphics{img/geo_base_comp_pm_min.eps}}
...
\end{align}
dont les solutions pour $[f_y,M_e]^T$ sont les points d'intersection des plans $\mathcal{i}$ et $\mathcal{j}$ lorsque $f_x=0$. I am adding stuff to edit the stuff
